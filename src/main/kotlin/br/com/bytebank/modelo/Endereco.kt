...
class Endereco(
    ...
    override fun toString(): String {
        return "Endereco(logradouro='$logradouro', numero=$numero, bairro='$bairro', cidade='$cidade', estado='$estado'," +
                " cep='$cep', complemento='$complemento')"
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true // melhor forma de verificar se são do mesmo tipo
        if (javaClass != other?.javaClass) return false //verifica se é nulo
